...
//#define MODE_STA // phone connect station
#define Smrtconfig // Smrtconfig
...
// For AP mode:
const char *ssid = "premaidai";  // You will connect your phone to this Access Point
const char *pw = "premaidai"; // and this is the password
...
#define SERIAL1_RXPIN 17            // receive Pin UART1
#define SERIAL1_TXPIN 16            // transmit Pin UART1
